...
CGameStateRun_4::CGameStateRun_4(CGame *g) : CGameState(g)
{
}

CGameStateRun_4::~CGameStateRun_4()
{
}

void CGameStateRun_4::OnBeginState()
{
}

void game_framework::CGameStateRun_4::OnInit()
{
...
void CGameStateRun_4::OnMove()							// 移動遊戲元素
{
	// 錢
...
void CGameStateRun_4::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) // 按esc快速返回
{
	if (nChar == VK_ESCAPE) {
...
void CGameStateRun_4::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{

}

void CGameStateRun_4::OnLButtonDown(UINT nFlags, CPoint point)  // 處理滑鼠的動作
{
	///////////////////////////////////
	// 藉由點擊次數生成相應數量貓咪
	///////////////////////////////////
...
void CGameStateRun_4::OnLButtonUp(UINT nFlags, CPoint point)	// 處理滑鼠的動作
{
}

void CGameStateRun_4::OnMouseMove(UINT nFlags, CPoint point)	// 處理滑鼠的動作
{
}

void CGameStateRun_4::OnRButtonDown(UINT nFlags, CPoint point)  // 處理滑鼠的動作
{
}

void CGameStateRun_4::OnRButtonUp(UINT nFlags, CPoint point)	// 處理滑鼠的動作
{
}

void CGameStateRun_4::OnShow()
{
...
void CGameStateRun_4::draw_text() {
	int Px = 1390;
